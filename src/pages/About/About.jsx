...
const About = () => {
    return (
        <div id='about' className='col lg:flex justify-center gap-5 pt-40'>
            <Fade left>
            ...
            <Fade right>
                <div className='pt-12'>
                    ...
                    <p className='flex gap-5 text-3xl mt-6 text-white'><a href="https://www.linkedin.com/in/pinki-roy-57590317b/" target="blank"><FaLinkedin></FaLinkedin></a>
